...
class Peserta_daftar extends Member_Controller
{
	...
	function tambah()
	{
		...
		if ($this->form_validation->run() == TRUE) {
			$data['user_name'] = ucwords(strtolower($this->input->post('tambah-username', true)));
			$data['user_password'] = $this->input->post('tambah-password', true);
			$data['user_email'] = $this->input->post('tambah-email', true);
			$data['user_firstname'] = ucwords(strtolower($this->input->post('tambah-nama', true)));
	...
	function edit()
	{
		...
		if ($this->form_validation->run() == TRUE) {
			...
			if ($pilihan == 'hapus') { //hapus
				...
				$data['user_firstname'] = ucwords(strtolower($this->input->post('edit-nama', true)));
